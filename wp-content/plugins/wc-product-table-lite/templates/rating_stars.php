...
foreach (array($full_stars, $half_stars, $empty_stars) as $key => $star_type) {
	while ($star_type) {
		if ($key === 0) {
			?><i class="wcpt-star wcpt-icon wcpt-star-full">
				<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" <?php echo $fill_style; ?>>
					<polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2">
					</polygon>
				</svg>
			</i><?php
		} else if ($key === 1) {
			?><i class="wcpt-star wcpt-icon wcpt-star-half">
					<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" <?php echo $fill_style; ?>>
						<polygon points="12 2 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon>
					</svg>
			...
			?><i class="wcpt-star wcpt-icon wcpt-star-empty">
					<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="#aaa">
						<polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2">
						</polygon>
					</svg>
