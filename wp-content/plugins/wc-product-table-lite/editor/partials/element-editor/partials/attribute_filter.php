...
<div class="wcpt-editor-row-option">
  ...
  <label>
    Attribute
    <small>Only <a href="https://docs.woocommerce.com/document/managing-product-taxonomies/#set-global-attributes"
        target="_blank">global attributes</a> are supported.</small>
  </label>
  <?php
