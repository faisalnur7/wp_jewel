...
foreach ( $variation_ids as $variation_id ) {
	...
	if ( ! $raw_label ) {
		$raw_label = isset( $variation_attributes[ 'attribute_' . $variation_attribute_name ] ) ? $variation_attributes[ 'attribute_' . $variation_attribute_name ] : '';
	}
	...
	if ( '' === $label ) {
		$label = strtoupper( sanitize_text_field( (string) $variation->get_slug() ) );
	}
